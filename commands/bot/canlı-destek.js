...
module.exports = class SupportCommand extends commando.Command {
  ...
  async run(message) {
    ...
    message.reply(`${this.client.emojis.get('464406478153973770')} Better Bot Desteği ile iletişim kurduğunuz için teşekkür ederiz! Herhangi bir destek yetkilisi varsa, yakında sizinle iletişim kuracaktır.`)
